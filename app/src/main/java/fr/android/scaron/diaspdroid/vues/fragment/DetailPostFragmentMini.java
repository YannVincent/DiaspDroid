    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        try {
            ...
            if (bundle != null) {
                ...
                webview = (WebView) getActivity().findViewById(R.id.detailPostText);
...
//                webview.getSettings().setLoadWithOverviewMode(true);
    ...
    private void removeYoutubeVideo(){
        if (supportFragmentManager.findFragmentById(R.id.detailPostObjectData)!=null)
        LOG.d("Class of findFragmentById(R.id.detailPostVideoYoutube) : "+supportFragmentManager.findFragmentById(R.id.detailPostObjectData).getClass().getName());
        Fragment frag = getActivity().getSupportFragmentManager().findFragmentById(R.id.detailPostObjectData);
