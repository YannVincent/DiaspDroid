 ...
 */
public class PodListViewAdapterOri extends BaseExpandableListAdapter {
    private static Logger LOGGEUR = LoggerFactory.getLogger(PodListViewAdapterOri.class);
    ...
    public PodListViewAdapterOri(FragmentActivity act, SparseArray<GroupList> groups, ExpandableListView litview){
        super();
        activity = act;
        this.groups = groups;
