...
public class DataControler extends DiasporaControler {
    ...
    public static void uploadImage(Context context, String localPath, String nameFile, final ProgressBar uploadProgressBar, FutureCallback<Response<String>> callback){
...
//            x-file-name:ic_launcher-web.png
    ...
    public static void uploadImage(Context context, String localPath, String nameFile, String message, final ProgressBar uploadProgressBar, FutureCallback<Response<UploadResult>> callback){
/*
...
//                    LOG.d(DataControler.class, ".getStream : On ajoute le cookie remember_user_token=" + COOKIE_SESSION_LOGIN);
//                    cookieControler.storeCookie(uri, "remember_user_token", COOKIE_REMEMBER);
//                }else {
//                    LOG.d(DataControler.class, ".getStream : On ajoute le cookie _diaspora_session=" + COOKIE_SESSION_STREAM);
//                    cookieControler.storeCookie(uri, "_diaspora_session", COOKIE_SESSION_STREAM);
//                }
//            }catch (IOException ioex){
