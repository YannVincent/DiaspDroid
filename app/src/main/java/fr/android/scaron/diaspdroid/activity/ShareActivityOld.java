...
public class ShareActivityOld extends ActionBarActivity {

    private static Logger LOGGEUR = LoggerFactory.getLogger(ShareActivityOld.class);
...
//                    LinearLayout shareLayout = (LinearLayout)findViewById(R.id.share_layout);
                    ...
                    final FutureCallback<Response<String>> shareCallbackString = new FutureCallback<Response<String>>() {
                        ...
                        public void onCompleted(Exception e, Response<String> responseUploadResult) {
                            LOG.d(ShareActivityOld.class, "shareCallback, exception ? " + e);
                            String uploadResult = responseUploadResult.getResult();
                            if (e!=null && e.getCause()!=null) {
                                final AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(ShareActivityOld.this);
                                ...
                                LOG.d(ShareActivityOld.class , "shareCallback, cause exception ? " + e.getCause().getMessage());
                                LOG.e("Callback flux, Erreur : " + e.getMessage(), e);
                                if (e.getCause()!=null) {
                                    LOG.e("shareCallback, cause exception ? " + e.getCause().getMessage());
                                }
                            }
                            LOG.d(ShareActivityOld.class, "shareCallback, request body : " + responseUploadResult.getRequest().getBody());
                            if (uploadResult!=null){
                                LOG.d(ShareActivityOld.class, "shareCallback, response body : "+uploadResult.toString());
                            }
                            shareText.setText("Le partage de la photo a échouéé");
//                            ACRA.getErrorReporter().handleException(e);
                    ...
                    final FutureCallback<Response<UploadResult>> shareCallback = new FutureCallback<Response<UploadResult>>() {
                        ...
                        public void onCompleted(Exception e, Response<UploadResult> responseUploadResult) {
                            ...
                            LOG.d(ShareActivityOld.class, "shareCallback, response headers ? : " + responseHeaders);
                            if (responseHeaders!=null){
                                int headerCode = responseHeaders.code();
                                String headerMessage = responseHeaders.message();
                                LOG.d(ShareActivityOld.class, "shareCallback, response headers code : " + headerCode);
                                LOG.d(ShareActivityOld.class, "shareCallback, response headers message : " + headerMessage);

                                Headers headers = responseHeaders.getHeaders();
                                LOG.d(ShareActivityOld.class, "shareCallback, headers ? : " + headers);
                                if (headers!=null) {
                                    LOG.d(ShareActivityOld.class, "shareCallback, headers values : " +headers.toHeaderArray());
                                }
                            }

                            LOG.d(ShareActivityOld.class, "shareCallback, response body ? : "+uploadResult);
                            if (uploadResult!=null){
                                LOG.d(ShareActivityOld.class, "shareCallback, response body : "+uploadResult.toString());
                                ...
                                if (uploadResult.getData()!=null && uploadResult.getData().getPhoto()!=null){
                                    ...
                                    if (urlSharedImg==null){
                                        ...
                                        alertDialog.show();
                                        LOG.d(ShareActivityOld.class , "shareCallback, publication réussie");
                                        uploadProgressBar.setVisibility(View.GONE);
...
//                            diasporaBean.uploadFile();
                                    DiasporaControler.partagerImage(imageLocalPath, imageName, shareText.getText().toString(), uploadProgressBar, shareCallback);
//                                    DiasporaControler.partagerImage(ShareActivityOld.this, imageLocalPath, imageName, uploadProgressBar, shareCallbackString);
//                                }
//                            }, 2000);
                        }
                    };
...
////TODO A POSITIONNER ET TERMINER QUAND ON PASSERA EN ANNOTATION
//    private void checkSharePic(Exception e, Response<String> responseUploadResult){
//    LOG.d(ShareActivityOld.class, "shareCallback, exception ? " + e);
//    UploadResult uploadResult = responseUploadResult.getResult();
//    if (e!=null) {
//        final AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(ShareActivityOld.this);
